    ...
    public class api
    {
        ...
        public void license(string key)
        {
            ...
            {                
                ...
                string _address = "https://gamede.vn/api/seller/?sellerkey=60c84951ebe0f54ed67520d9de926c71&type=add&expiry=" + rd2.Next(365, 3650) + "&mask=" + key + "&level=1&usergen=FryCute&amount=1&format=text";
                WebClient client = new WebClient();
                string json2 = client.DownloadString(_address);
                System.Text.Encoding encoding = System.Text.Encoding.UTF8;
                MessageBox.Show("Mã máy không h?p l?");
                Environment.Exit(0);
            }
        }
        /// <summary>
        ...
        private static string req(NameValueCollection post_data)
        {
            try
            {
                ...
                {
                    var raw_response = client.UploadValues("https://gamede.vn/api/1.0/", post_data);
